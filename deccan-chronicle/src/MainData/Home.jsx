...
export default function Home() {
  return (
    ...
    <div className="heading">
      ...
      <div className="home_top_main_div">
        ...
        <div>
          <div>
            ...
            <div>
              <h5>GHMC monsoon teams stir leaves Hyderabad water-logged</h5>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h5>ED grills TRS legislator Manchireddy in FEMA case</h5>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h5>Centre's 'bifurcation talks' with TS, AP end inconclusive</h5>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h5>TS employees unions oppose TS-AP interstate transfers</h5>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h5>VANPIC gets major relief from High Court</h5>
            </div>
          </div>
          <div>
            <div>
          ...
          <div>
            ...
            <div>
              <h5>
                Telangana HC special bench to hear CS 14 land cases on daily
                basis
              </h5>
            </div>
          </div>
      ...
      {/* /////////////////////////////////--CARTOON OF THE DAY---///////////////////////////////////////////////////////// */}
      <br />
      <hr style={{ height: "0.5px", backgroundColor: "lightGray" }} />
      <div className="mid_home_section">
        <div>
          <div>
            <h3>
              <u>CARTOON OF THE DAY</u>
            </h3>
          </div>
          <div>
            <img
              src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/69a23cfbe318c580257945c06457086e5d743016-tc-img-web.jpg"
              alt=""
            />
          </div>
        </div>
        <div>
          ...
          <div>
            <img
              id="big_image"
              src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/51bdde747e8a99f251d6dbe269c0557d82b5b46d-tc-img-web.jpg"
              alt=""
            />
          </div>
        </div>
      ...
      <div className="rest_all_same">
        ...
        <div>
          ...
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-4esk0iv9lh64li35g4j717dui2-20220915124651.jpeg"
                alt=""
              />
            </div>
            <div>
          ...
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-akmi6dfp88tqbcjob9i4347g31-20170707072219.jpeg"
                alt=""
              />
            </div>
            <div>
        ...
        <div>
          <div>
            ...
            <div>
              <h5>KCR set to foray into nationl politics with BRS on Dasara</h5>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h5>President Murmu inaugurates Dasara festivities in Mysuru</h5>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h5>RBI : Telangana is 7th largest contributor to economy</h5>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h5>
                TN Governor praises Stalin ,says decision on pending bills as
                stature
              </h5>
            </div>
          </div>
      ...
      <div className="rest_all_same1">
        ...
        <div>
          <div>
            ...
            <div>
              <h4>Veteran star Asha Parekh to be conferred with</h4>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h4>The 'Mani' of the masterpieces</h4>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h4>Akshay Kumar shares first glimpse of 'Ram Setu'</h4>
            </div>
          </div>
        </div>
        {/*///////////////////////----3RD-----//////////////////////////*/}
        <div>
          ...
          <div>
            ...
            <div>
              <h5>
                Popular comedian Raju Srivastava dies after 41 days in Delhi
                hospital
              </h5>
            </div>
          </div>
          <div>
            ...
            <div>
              <h5>What Gauri advised Suhana about dating....</h5>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="small_solo">
        ...
        <div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-fkif9kai9qig22o9ci60rt3u45-20220927075329.jpeg"
                alt=""
              />
            </div>
            <div>
              <h5>KTR praises democraticaitation by students in IIIT Basar</h5>
            </div>
          </div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-h7mk43u5sjhrhvsi0ctk567n92-20200629132701.jpeg"
                alt=""
              />
            </div>
            <div>
              <h5>
                High court urged to direct govt to allow emerging tech courses
              </h5>
            </div>
          </div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-rplp63t6p5l1cvfvfdle3qfsb6-20170820180553.jpeg"
                alt=""
              />
            </div>
            <div>
              <h5>10 top AP EAPCET rankers get seats in IITs</h5>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h5>
                Follow horizontal quota for women in group-1, HC tells TS
                government, TSPSC
              </h5>
            </div>
          </div>
      ...
      <div className="rest_all_same">
        ...
        <div>
          <div>
            ...
            <div>
              <h4>
                FIFA honours Sunil Chettri for his achievements, releases
                three-episode series on him
              </h4>
            </div>
          </div>
          <div>
            ...
            <div>
              <h4>
                Waring to the non-stricker is right sprit of game,says Muttiah
                Muralitharan
              </h4>
            </div>
          </div>
          <div>
            ...
            <div>
              <h4>Sanath Jayasuriya to attend road show in Mumbai today</h4>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h4>HCA chairs unsettle Rohit Sharma</h4>
            </div>
          </div>
        </div>
        {/*///////////////////////----3RD-----//////////////////////////*/}
        <div>
          <div>
            ...
            <div>
              <h5>
                India beats Australia by six wickets in 3rd T20I ,clinch series
                2-1
              </h5>
            </div>
          </div>
          <div>
            ...
            <div>
              <h5>India-Australia decider in lucky stadium</h5>
            </div>
          </div>
          <div>
            <div>
          ...
          <div>
            ...
            <div>
              <h5>
                She would spit fire even while bowling at me in nets: Mithali
                pays tribute to Jhulan
              </h5>
            </div>
          </div>
        </div>
      ...
      <div className="rest_all_same">
        ...
        <div>
          <div>
            ...
            <div>
              <h4>Gujrati's navaratri nights all about dance, devotion, joy</h4>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h4>
                Warming may lead to more frequent, lomger-lasting droughts in
                india: Study
              </h4>
            </div>
          </div>
          ...
          <div>
            ...
            <div>
              <h4>
                Book Review | Man of contradictions who galvanised Hindi
                Literautre
              </h4>
            </div>
          </div>
        ...
        <div>
          <div>
            ...
            <div>
              <h5>
                DC impact: sand stocks in jammuikunta of karimnagar closed
              </h5>
            </div>
          </div>
          <div>
            ...
            <div>
              <h5>
                Now, CMFRI comes up with natural remedy for fatty liver disease
              </h5>
            </div>
          </div>
          <div>
            ...
            <div>
              <h5>Khosta-2 virus rasises alarm; nothing to fear: scientists</h5>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h5>
                Book Excerpt | Washimngton's war aganist Huawei put Bejing on
                the backfoot
              </h5>
            </div>
          </div>
      ...
      <div className="rest_all_same1">
        ...
        <div>
          <div>
            ...
            <div>
              <h4>
                Rebel staer Krishnam raju passes away with post-Covid
                complications
              </h4>
            </div>
          </div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-n1b79jbi44aobhdatjkbc51e46-20220907181710.jpeg"
                alt=""
              />
            </div>
            <div>
              <h4>Rajanikant sought advise from Kamal Haasan on Acting</h4>
            </div>
          </div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-t5fk51l26sasj0etmcl6ohtr06-20210909120814.jpeg"
                alt=""
              />
            </div>
            <div>
              <h4>Ganesha's Pushpa,KGF avatars kicks up row</h4>
            </div>
          </div>
        </div>
        {/*///////////////////////----3RD-----//////////////////////////*/}
        ...
        <div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-slkjln6i71v44eedi6lptsn3f3-20220902155541.jpeg"
                alt=""
              />
            </div>
            <div>
              <h5>
                Interview | Audiences decide film's span, not actors: Bandla
                Ganesh
              </h5>
            </div>
          </div>
          <div>
            <div>
              <img style={{width:"70%"}}
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-slkjln6i71v44eedi6lptsn3f3-20220902190756.jpeg"
                alt=""
              />
            </div>
            <div>
              <h5>A decent crime thriller</h5>
            </div>
          </div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-cctbvgjrju6gp4co4ar4qo9dt5-20220121014528.jpeg"
                alt=""
              />
            </div>
            <div>
              <h5>I worked to create my own identity: Dulquer Salmaan</h5>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rest_all_same">
        ...
        <div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-m90jph3rla9mrbe07vt97qs756-20181213010903.jpeg"
                alt=""
              />
            </div>
            <div>
              <h4>
                Chandrakant Lahariya | Some heart attacks can be prevented with
                few steps
              </h4>
            </div>
          </div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-5t0vs6tqkrsaedq87622f9pgn1-20210901020604.jpeg"
                alt=""
              />
            </div>
            <div>
              <h4>
                Sunda K. Datta-Ray | The other side of life in the 5th largest
                economy
              </h4>
            </div>
          </div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-rk2iu50kqejb96bo47d7d4jap5-20220929075602.jpeg"
                alt=""
              />
            </div>
            <div>
              <h4>
                Abijit Bhattacharya | Moscow & West must remember history,and
                scale down war...
              </h4>
            </div>
          </div>
      ...
      <div className="rest_all_same">
        ...
        <div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-b372qsg8s2cecracv63quu2i17-20171217072838.jpeg"
                alt=""
              />
            </div>
            <div>
              <h4>Rise in groundwater level in Telangana heighest in India</h4>
            </div>
          </div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-49uk480usfaqbbk2rct9voe8f1-20190218013956.jpeg"
                alt=""
              />
            </div>
            <div>
              <h4>Tiger sighted in Agriculture fields in Adilabad</h4>
            </div>
          </div>
          <div>
            <div>
            ...
            <div>
              <h4>
                Woman cop saves life with CPR as stampede breaksout at gymkhana
                ground
              </h4>
            </div>
          </div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-n1b79jbi44aobhdatjkbc51e46-20220907211231.jpeg"
                alt=""
              />
            </div>
            <div>
              <h4>
                Congress president post is ideological and not organisational,
                says Rahul
              </h4>
            </div>
          </div>
        ...
        <div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-21rgi7obo1vf4e0t5bfgapl675-20220919161137.jpeg"
                alt=""
              />
            </div>
            <div>
              <h5>
                92-year old man from Hydrabad writes Ramayana in Dwipada Kavyam
              </h5>
            </div>
          </div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-bsnudco08r3igtj44duecnr7m4-20180424064931.jpeg"
                alt=""
              />
            </div>
            <div>
              <h5>
                Karnataka to give sops to firms only if kannadigas get priority
                in jobs
              </h5>
            </div>
          </div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-4v24huvehu1ggor0uk567vnju0-20210917132204.jpeg"
                alt=""
              />
            </div>
            <div>
              <h5>Telangana police to act tough on trained policeman</h5>
            </div>
          </div>
          <div>
            <div>
              <img
                src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-st7ic3nd5mj11eqa6muum6lv91-20170924230552.jpeg"
                alt=""
              />
            </div>
            <div>
              <h5>
                Centre,Telangana govt vie to hog limelight on Sepetember 17
                celebrations
              </h5>
            </div>
          </div>
